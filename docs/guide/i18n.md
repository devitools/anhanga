...
`@anhanga/react` and `@anhanga/vue` provide the same helper functions for label resolution:

```typescript
import { resolveFieldLabel, resolveGroupLabel, resolveActionLabel } from '@anhanga/react' // or '@anhanga/vue'
