...
In the [Installation](/react-native/installation) step you created `i18n.ts` with just the base translations. Now update it to merge your domain translations:
