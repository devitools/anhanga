...
```typescript
// src/lib/domain/product/schema.ts
...
```typescript
// src/lib/domain/product/events.ts
...
```typescript
// src/lib/domain/product/handlers.ts
...
```typescript
// src/lib/domain/product/hooks.ts
...
```typescript
// src/lib/application/product/productService.ts
...
- [i18n](/svelte/i18n) — add field labels and group titles for your schema
